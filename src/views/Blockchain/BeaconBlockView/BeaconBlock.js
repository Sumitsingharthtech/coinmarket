...
function BeaconBlock({ block, className, ...rest }) {
        ...
        <TableBody>
          ...
          <TableRow>
            ...
            <TableCell>
              <Link
                ...
                to={`/blockchain/beacon-chain/${block.previousBlockHash}`}
              >
                <Hidden smDown>
          ...
          <TableRow>
            ...
            <TableCell>
              ...
              <Link
                component={RouterLink}
                to={`/blockchain/beacon-chain/${block.nextBlockHash}`}
              >
                <Hidden smDown>
                  {block.nextBlockHash}
                </Hidden>
