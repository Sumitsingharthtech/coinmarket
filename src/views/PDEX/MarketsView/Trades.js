...
function Trades({
  className, page, limit, trades, count, hideSmallTrades, onPageChanged, onLimitChanged, onHideSmallTradesChanged, pair, ...rest
}) {
  ...
  return (
    ...
    >
      <Card>
        ...
        <Divider />
        <Box>
          { trades && <TradesList showPair={false} fullVersion trades={trades} /> }
        </Box>
      </Card>
    </div>
  );
